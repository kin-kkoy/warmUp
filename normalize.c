...
/*
    - FOUND OUT AFTER THAT IT SHOULD'VE BEEN SET AS A FLOAT FROM THE START, THE INPUT ARRAY I MEAN. SINCE IT'S APPARENTLY
      STANDARD THAT THEY ARE FLOATS/DECIMALS AND EVEN IF THE INPUT/DATASET MAY BE IN DECIMAL, DIVIDING CAN PRODUCE FLOATS.
*/